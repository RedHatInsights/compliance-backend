...
RSpec.describe SupportedSsg do
  ...
  describe '.ssg_versions_for_os' do
    let(:supported) do
      [
        described_class.new(os_major_version: '9', os_minor_version: '4', version: '0.1.73'),
        described_class.new(os_major_version: '9', os_minor_version: '4', version: '0.1.73'),
        described_class.new(os_major_version: '9', os_minor_version: '4', version: '0.1.81')
      ]
    end

    it 'returns the deduplicated versions shipped for the OS' do
      expect(described_class.ssg_versions_for_os(9, 4)).to contain_exactly('0.1.73', '0.1.81')
    end
  end
  ...
  describe 'minor upgrades, downgrades and two-digit minors' do
    ...
    it 'treats a two-digit minor as an integer, not a plain string' do
