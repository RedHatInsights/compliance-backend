...
describe PoliciesController do
  ...
  context '/policies' do
    ...
    describe 'GET show' do
      let(:item) { FactoryBot.create(:policy, account: current_user.account).reload }
    ...
    describe 'POST create' do
      ...
      subject { Policy.find(response_body_data['id']) }
    ...
    describe 'PATCH update' do
      let(:item) { FactoryBot.create(:policy, account: current_user.account) }
    ...
    describe 'DELETE destroy' do
      ...
      context 'policy under different account' do
        let(:item) { FactoryBot.create(:policy, account: FactoryBot.create(:account)) }
