...
describe 'Rule Groups', swagger_doc: 'v2/openapi.json' do
  ...
  path '/security_guides/{security_guide_id}/rule_groups' do
    before { FactoryBot.create_list(:rule_group, 25, security_guide_id: security_guide_id) }
    ...
    get 'Request Rule Groups' do
      ...
      ids_only_param
      sort_params_v2(RuleGroup)
      search_params_v2(RuleGroup)
  ...
  path '/security_guides/{security_guide_id}/rule_groups/{rule_group_id}' do
    let(:item) { FactoryBot.create(:rule_group) }
