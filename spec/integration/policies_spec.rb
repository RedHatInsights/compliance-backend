...
describe 'Policies', swagger_doc: 'v2/openapi.json' do
  ...
  path '/policies' do
    before { FactoryBot.create_list(:policy, 25, account: user.account) }
    ...
    get 'Request Policies' do
      ...
      ids_only_param
      sort_params_v2(Policy)
      search_params_v2(Policy)
  ...
  path '/policies/{policy_id}' do
    let(:item) { FactoryBot.create(:policy, account: user.account) }
  ...
  path '/systems/{system_id}/policies' do
    ...
    get 'Request Policies assigned to a System' do
      ...
      pagination_params_v2
      ids_only_param
      sort_params_v2(Policy, except: %i[os_major_version total_system_count])
      search_params_v2(Policy, except: %i[os_major_version])
