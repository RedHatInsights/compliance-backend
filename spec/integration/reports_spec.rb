...
describe 'Reports', swagger_doc: 'v2/openapi.json' do
  ...
  path '/reports' do
    ...
    get 'Request Reports' do
      ...
      ids_only_param
      sort_params_v2(Report)
      search_params_v2(Report)
  ...
  path '/systems/{system_id}/reports' do
    ...
    get 'Request Reports' do
      ...
      pagination_params_v2
      ids_only_param
      sort_params_v2(Report, except: %i[os_major_version])
      search_params_v2(Report, except: %i[os_major_version with_reported_systems percent_compliant])
