...
ARG devDeps="gcc gcc-c++ libstdc++-static rustup rust cargo gzip libffi-devel libyaml-devel make openssl-devel patch postgresql postgresql-devel redhat-rpm-config ruby-devel tar which util-linux xz"
ARG extras=""
ARG prod="true"
