ARG deps="findutils hostname jq libpq ruby shared-mime-info tzdata"
ARG devDeps="gcc gcc-c++ gzip libffi-devel make postgresql-devel ruby-devel tar util-linux"
...
ENV RAILS_ENV=production RAILS_LOG_TO_STDOUT=true HOME=/opt/app-root/src devDeps=$devDeps
