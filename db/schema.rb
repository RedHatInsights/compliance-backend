...
ActiveRecord::Schema[8.0].define(version: 2025_12_22_120519) do
  ...
  create_table "rule_group_relationships_v2", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.index ["left_id", "right_id", "right_type", "left_type", "relationship"], name: "uniq_index_rule_group_relationships_v2", unique: true
  ...
  create_table "rule_groups_v2", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["rule_id"], name: "index_rule_groups_v2_on_rule_id"
  ...
  create_table "rules_v2", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["rule_group_id"], name: "index_rules_v2_on_rule_group_id"
