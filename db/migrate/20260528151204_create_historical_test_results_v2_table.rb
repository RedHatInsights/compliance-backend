class CreateHistoricalTestResultsV2Table < ActiveRecord::Migration[8.0]
  def up
    ...
    add_index :historical_test_results_v2, [:tailoring_id, :system_id, :end_time], order: { end_time: :desc }, name: 'index_historical_test_results_v2_for_latest_lookup', include: %i[id]
  end
