SELECT
  ...
  COALESCE("sq"."system_count", 0) AS "system_count",
  "policies"."profile_id",
  "policies"."account_id"
FROM "policies"
  LEFT OUTER JOIN "business_objectives" ON "business_objectives"."id" = "policies"."business_objective_id"
  LEFT OUTER JOIN (
    SELECT COUNT("policy_hosts"."host_id") AS "system_count", "policy_hosts"."policy_id" FROM "policy_hosts" GROUP BY "policy_hosts"."policy_id"
