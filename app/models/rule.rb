...
class Rule < ApplicationRecord
  ...
  belongs_to :rule_group, class_name: 'RuleGroup', optional: true
  has_many :profile_rules, class_name: 'ProfileRule', dependent: :destroy
  has_many :profiles, through: :profile_rules, source: :profile, class_name: 'Profile'
  has_many :tailoring_rules, class_name: 'TailoringRule', dependent: :destroy
  has_many :tailorings, through: :tailoring_rules, class_name: 'Tailoring'
  has_many :policies, class_name: 'Policy', through: :tailorings
