...
module V2
  ...
  class Report < ApplicationRecord
    ...
    ALL_SYSTEMS_EXPOSED = lambda do
      total = AN::NamedFunction.new('COUNT', [V2::System.arel_table[:id]])
      scoped = SYSTEM_COUNT.call

      AN::NamedFunction.new('CAST', [Arel::Nodes::Equality.new(total, scoped).as('boolean')])
    end
    ...
    def all_systems_exposed # rubocop:disable Naming/PredicateMethod
      try(:aggregate_all_systems_exposed)
    end
