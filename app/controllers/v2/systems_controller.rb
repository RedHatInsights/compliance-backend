...
module V2
  ...
  class SystemsController < ApplicationController
    ...
    v2_permission_for_action :index, KesselRbac::SYSTEM_VIEW

    def show
      render_json system
    end
    permission_for_action :show, Rbac::SYSTEM_READ
    v2_permission_for_action :show, KesselRbac::SYSTEM_VIEW
    ...
    v2_permission_for_action :destroy, KesselRbac::POLICY_EDIT
    ...
    v2_permission_for_action :os_versions, KesselRbac::SYSTEM_VIEW
