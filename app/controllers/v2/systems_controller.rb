...
module V2
  ...
  class SystemsController < ApplicationController
    ...
    v2_permission_for_action :index, KesselClient::SYSTEM_VIEW

    def show
      render_json system
    end
    permission_for_action :show, Rbac::SYSTEM_READ
    v2_permission_for_action :show, KesselClient::SYSTEM_VIEW
    ...
    v2_permission_for_action :destroy, KesselClient::POLICY_EDIT
