...
module V2
  ...
  class TestResultsController < ApplicationController
    ...
    v2_permission_for_action :index, KesselClient::REPORT_VIEW

    def show
      render_json test_result
    end
    permission_for_action :show, Rbac::REPORT_READ
    v2_permission_for_action :show, KesselClient::REPORT_VIEW

    def os_versions
      render json: test_results.os_versions, status: :ok
    end
    permission_for_action :os_versions, Rbac::SYSTEM_READ
    v2_permission_for_action :os_versions, KesselClient::SYSTEM_VIEW
    ...
    v2_permission_for_action :security_guide_versions, KesselClient::REPORT_VIEW
