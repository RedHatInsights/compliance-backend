...
module Xccdf
  ...
  module SecurityGuides
    ...
    included do
      ...
      def package_name
        @package_name ||= begin
          # TODO: perhaps the object is not saved yet, so we dont have os_major_version yet
          #       and we need to parse the ref_id ourselves
          SupportedSsg.by_os_major[security_guide.os_major_version].find do |item|
